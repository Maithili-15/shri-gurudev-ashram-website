  ...
  return (
    <Link to={`/shop/${product.id}`} className="block">
      <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden border border-amber-100">
        ...
        <div className="p-4">
          <h3 className="text-lg font-bold text-amber-900 mb-2 line-clamp-2">{product.name}</h3>
          <p className="text-2xl font-bold text-amber-700 mb-2">{formatCurrency(product.price)}</p>
